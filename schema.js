// Event Modeling JSON Schema (draft-07), embedded so the editor works offline
// over file://. Source: https://github.com/dilgerma/event-modeling-spec
window.EVENT_MODELING_SCHEMA = {
  ...
  "$defs": {
    "Slice": {
      ...
      "properties": {
        ...
        "screenImages": { "type": "array", "items": { "$ref": "#/$defs/ScreenImage" } },
      ...
      "required": ["id", "title", "sliceType", "commands", "events", "readmodels", "screens", "processors", "tables", "specifications"],
      "additionalProperties": false
    },
    "Element": {
      "type": "object",
    ...
    "Dependency": {
      ...
      "properties": {
        ...
        "title": { "type": "string" },
        "elementType": { "type": "string", "enum": ["EVENT", "COMMAND", "READMODEL", "SCREEN", "AUTOMATION"] }
      },
